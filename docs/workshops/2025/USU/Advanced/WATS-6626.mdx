...
*Prerequisite Recommendations*: Students are recommended to be proficient in GIS (See: [getting started in QGIS](https://riverscapes.freshdesk.com/support/solutions/articles/153000083973-getting-oriented-in-qgis) for self-paced; see [USU's Geospatial Collective](https://www.usu.edu/geospatial/) for more formal training options).
