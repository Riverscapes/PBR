...
Content drew on over 20 prior [LTPBR workshops](/workshops/) and online modules developed in [2020](/workshops/2020/SGI/overview) for NRCS Working Lands for Wildlife.
...
- **Stephen N. Bennett**  
  ...
  ![](https://docs.riverscapes.net/img/people/steve_bennett.png)

- **Joseph Wheaton**  
  Professor of Riverscapes  
  ![](https://docs.riverscapes.net/img/people/joe_wheaton.png)
...
- **Mark Beardsley**  
  Ecologist  
  ![](https://docs.riverscapes.net/img/people/mark_beardsley.png)

- **Nicolaas Bouwes**  
  Aquatic Ecologist, Adjunct Professor  
  ![](https://docs.riverscapes.net/img/people/nic_bouwes.png)

- **Ben Goldfarb**  
  Author, Environmental Journalist, Beaver Believer  
  ![](https://docs.riverscapes.net/img/people/ben_goldfarb.png)

- **Jeremy Maestas**  
  Ecologist  
  ![](https://docs.riverscapes.net/img/people/jeremy_maestas.png)

- **Scott Shahveridan**  
  Fluvial Geomorphologist  
  ![](https://docs.riverscapes.net/img/people/scott_shahverdian.png)

- **Colin Thorne**  
  Professor of Physical Geography  
  ![](https://docs.riverscapes.net/img/people/colin_thorne.png)

- **Nick Weber**  
  Fish Ecologist  
  ![](https://docs.riverscapes.net/img/people/nick_webber.png)
