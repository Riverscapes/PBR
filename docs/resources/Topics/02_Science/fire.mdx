...
[![Fire Resilience](/img/pics/FireResilience.png)](/workshops/2020/SGI/Modules/module1#j-principles-of-healthy-riverscapes)

The idea that beaver dams can improve the resiliency of riverscapes to fire is common sense. That argument is made in [Module 1's Principles Lecture](/workshops/2020/SGI/Modules/module1#j-principles-of-healthy-riverscapes). This page highlights examples, anecdotes, and the surprisingly [small amount (but convincing) of published scientific evidence](https://en.wikipedia.org/wiki/North_American_beaver#Beaver_ponds_as_wildlife_refugia_and_firebreaks_in_wildfires) behind the idea that *“It’s really not complicated: water doesn’t burn…”* ([National Geographic](https://www.nationalgeographic.com/animals/2020/09/beavers-firefighters-wildfires-california-oregon/)).
...
<YouTubeEmbed videoId="IAM94B73bzE" title="Emily Fairfax’s Stop-Motion Explainer: Fire Resilience" width={560} height={315} />
...
[Listen to the NPR segment here](https://www.npr.org/player/embed/1046779486/1046779487)
...
[Watch the Beaver Believers documentary on Vimeo](https://player.vimeo.com/video/96654872?color=697d4a)
...
<YouTubeEmbed videoId="zFXYOejzDZA" title="California Beaver Summit talk on resilience" width={560} height={315} />

- [Smokey the Beaver webinar](https://www.youtube.com/embed/39CWo2Qk7TM)

<YouTubeEmbed videoId="39CWo2Qk7TM" title="Smokey the Beaver webinar" width={560} height={315} />

### Joe Wheaton

- [LTPBR Workshop principles lecture excerpt](https://www.youtube.com/embed/v5gZQDEXlxQ?start=700)

<YouTubeEmbed videoId="v5gZQDEXlxQ" title="LTPBR Workshop principles lecture excerpt" width={560} height={315} start={700} />
...
<YouTubeEmbed videoId="VhnnX9e0NjE" title="Low-Tech Process-Based Restoration: Applications to Post Wildfire Landscapes" width={560} height={315} />
